...
namespace Checkout.Helpers
{
    ...
    public class ContentAdaptor
    {
        ...
        public static System.Collections.Generic.List<T> JsonStringToObject2<T>(string jsonString)
        {
			return Task.Factory.StartNew(() => JsonConvert.DeserializeObject<System.Collections.Generic.List<T>>(jsonString)).Result;
