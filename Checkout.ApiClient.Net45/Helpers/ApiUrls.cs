namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _productsApiUri;
        private static string _productApiUri;
        ...
        //to check baseapi uri
        public static string Customer
            => _customerApiUri ?? (_customerApiUri = string.Concat(AppSettings.BaseApiUri, "/customers/{0}"));

        public static string Product
            => _productApiUri ?? (_productApiUri = string.Concat("http://localhost:51283/api", "/products/{0}"));
